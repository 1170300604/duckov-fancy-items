...
namespace FancyItems.Core
{
    public static class ModSetting
    {
        ...
        public static float[] SearchTimeOptimization = {
            0.8f, 0.8f, 0.9f, 1.0f, 1.0f, 1.2f, 2.0f
        };

        private static readonly Dictionary<string, int> d1 = new Dictionary<string, int>();

        public static int[] QualityColor = {
            1, 1, 2, 3, 4, 5, 6
        };
        ...
        public static void Init()
        {
            ...
            {
                d1.Add(Localizations.ModLocalization.GetText("colorName0"), 0);
                d1.Add(Localizations.ModLocalization.GetText("colorName1"), 1);
                d1.Add(Localizations.ModLocalization.GetText("colorName2"), 2);
                d1.Add(Localizations.ModLocalization.GetText("colorName3"), 3);
                d1.Add(Localizations.ModLocalization.GetText("colorName4"), 4);
                d1.Add(Localizations.ModLocalization.GetText("colorName5"), 5);
                d1.Add(Localizations.ModLocalization.GetText("colorName6"), 6);
                d1.Add(Localizations.ModLocalization.GetText("colorName7"), 7);
        ...
        public static void ResetSearchTimeOptimization() => SearchTimeOptimization = new[] {
            0.8f, 0.8f, 0.9f, 1.0f, 1.0f, 1.2f, 2.0f
        };

        public static void ResetQualityOptimization() => QualityColor = new[] {
            1, 1, 2, 3, 4, 5, 6
        };
    }
}